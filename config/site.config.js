...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'pranaya@334s3m.onmicrosoft.com',
  ...
  googleFontLinks: ['https://fonts.googleapis.com/css2?family=Martian+Mono&family=Inter:wght@400;500;700&display=swap'],
